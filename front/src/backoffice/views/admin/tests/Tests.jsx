...
import TableTest from './components/TableTests'; // adjust the path as needed
import TableResponses from './components/TableResponses'; // adjust the path as needed
...
>
  {showTable ? 'Hide Tests and Responses' : 'Display Tests and Responses'}
</button>
