...
const Chat = ({GroupId,openChat,toggleChat}) => {
  ...
  return (
    <div className="">
        <>
          <div
            className="fixed inset-0 bg-black bg-opacity-50 z-40 text-blueSecondary bg-blueSecondary "
            onClick={toggleChat}
          />
      {/* messages Header */}      
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg border border-gray-300 w-[640px] h-[634px] shadow-lg z-50  ">
            <div className="flex justify-between items-center pb-4 border-b">
              ...
              <div className="flex ">
                    <button
                        className="mx-2 inline-flex  items-center justify-center rounded-full text-sm font-medium text-white bg-blueSecondary hover:bg-blue-900 h-8 px-4 py-2"
                        >
                            <MdVideoCall 
                      ...
                      <>
                          ...
                          {msg.media.type === 'audio' && (
                            ...
                            style={{
                              ...
                              <button
                                ...
                                className="flex-shrink-0 w-10 h-10 rounded-full bg-blueSecondary text-white mr-3"
                              >
                                {isPlaying ? (
                              ...
                              <div className="flex-grow">
                                <div className="relative h-1 rounded-full bg-gray-200">
                                  <div
                                    className="absolute top-0 left-0 h-full bg-gradient-to-r from-blueSecondary to-purple-500 rounded-full"
                        ...
                        {msg.media.type === 'pdf' && (
                          <div className="mt-2 flex items-center space-x-2">
                            {/* PDF Icon */}
                            <FaFilePdf
                              className={`w-6 h-6 ${msg.sender._id !== loggedUser._id ? "text-blueSecondary" : "text-white"}`}
                            />                            {/* PDF Link */}
                            <a
                              href={`http://localhost:5000${msg.media.url}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className={`${msg.sender._id !== loggedUser._id ? "text-blueSecondary" : "text-white"}`}
                              >
                              View Pdf File
                            </a>
                          </div>
      ...
      {/* messages Footer */}      
            ...
            <button
                type="submit"
                className="ml-2 inline-flex items-center justify-center rounded-md text-sm font-medium text-white bg-blueSecondary hover:bg-blue-900 h-10 px-4 py-2"
            >
                <MdMic 
                className="text-white" 
                size={24} 
              ...
              <button
                type="submit"
                className="ml-2 mr-2 inline-flex items-center justify-center rounded-md text-sm font-medium text-white bg-blueSecondary hover:bg-blue-900 h-10 px-4 py-2"
              ...
              <input
                type="text"
                className="flex h-10 w-full rounded-md border border-blueSecondary px-3 py-2 text-sm placeholder-blueSecondary- focus:outline-none focus:ring-2 focus:ring-blueSecondary text-gray-900 "
