  ...
  return (
    <div className="fixed bottom-16 right-4 z-50">
      ...
      <button
        ...
        className="bg-blueSecondary text-white p-3 rounded-full shadow-lg hover:bg-blue-900 transition-colors"
      >
        <FaBell size={20} />
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            {/* Header */}
            <div className="bg-blueSecondary text-white p-4 flex justify-between items-center">
