...
import ResourceAdminDetails from "backoffice/views/admin/resources/components/ResoucesAdminDetails";
import ResourcesAdmin from "backoffice/views/admin/resources/resourcesAdmin";
import StatiqueEvent  from "./backoffice/views/events/components/StatiqueEvent";
import DashboardA from "backoffice/views/admin/dashboard/Dashboard";
...
},
{
  ...
  role:'admin',
  layout: "/admin",
  path: "Ressources-View",
  icon: <MdBook className="h-6 w-6" />,
  component: <ResourcesAdmin/>,
},
{
  name: "Resources Admin Details",
  role:'none',
  layout: "/admin",
  path: "resources/RessourcesDetails-View/:id",
  icon: <MdBook className="h-6 w-6" />,
  component: <ResourceAdminDetails/>,
},
{
...
},
{
  ...
  role: "admin",
  layout: "/admin",
  path: "EventsManagement/event-reservations/:id",
